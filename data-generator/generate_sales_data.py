...
def main():
    ...
    # A 4th, distinct day -- deliberately NOT one of the 3 regular sample
    # days above, so this doesn't silently overwrite a regular file.
    peak_date = start_date + timedelta(days=len(days))
    print("\nGenerating one peak-day file (~150 MB) to test block sizing...")
    write_store_file("STORE_001", peak_date, target_mb=150)
